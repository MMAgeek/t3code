...
// The upstream "release workflow tracing config propagation" suite lived here.
// It read .github/workflows/release.yml and asserted the relay tracing token
// travels as an artifact rather than a masked cross-job output. This fork does
// not ship a release workflow, so the guard has nothing to guard.
